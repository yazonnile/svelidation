...
function create_fragment(ctx) {
	...
	let t3;
	let show_if_3 = ctx.$loginStore.errors.includes("minLength");
	let t4;
	let show_if_2 = ctx.$loginStore.errors.includes("maxLength");
	let t5;
	let label1;
	let t6;
	let input1;
	...
	let dispose;
	let if_block0 = show_if_3 && create_if_block_3();
	let if_block1 = show_if_2 && create_if_block_2();
	let if_block2 = show_if_1 && create_if_block_1();
	...
	let if_block3 = show_if && create_if_block();
	...
	return {
		...
		p(changed, ctx) {
			...
			if (changed.$loginStore) show_if_3 = ctx.$loginStore.errors.includes("minLength");
			...
			if (changed.$loginStore) show_if_2 = ctx.$loginStore.errors.includes("maxLength");
...
function create_if_block_3$1(ctx) {
	...
	let if_block1 = show_if && create_if_block_4();
